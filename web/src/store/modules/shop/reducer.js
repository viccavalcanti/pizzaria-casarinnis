...
function shop(state = INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case types.SET_PIZZARIAS: {
      return produce(state, (draft) => {
        draft.pizzarias = action.pizzarias;
      });
    }

    case types.SET_PIZZARIA_MAP_SELECTED: {
      return produce(state, (draft) => {
        draft.pizzariaMapSelected = action.pizzaria;
      });
    }
    ...
    case types.SET_PIZZARIA: {
      return produce(state, (draft) => {
        draft.pizzaria = action.pizzaria;
      });
    }
